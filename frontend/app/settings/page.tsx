    ...
    <AnimatedContainer className="space-y-4">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <article className="glass rounded-2xl p-5">
          ...
          <p className="mt-1 text-sm text-muted">Selected filters persist locally between visits.</p>
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        ...
        <article className="glass rounded-2xl p-5">
          <p className="text-sm text-muted">Observation Window</p>
          <p className="mt-2 text-lg font-semibold">{data ? formatHours(data.observation_window_hours) : "No window yet"}</p>
        </article>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-4">
        ...
        <article className="glass rounded-2xl p-5">
          ...
          <p className="mt-2 text-lg font-semibold">{data ? formatPercent(data.clean_record_ratio) : "0.0%"}</p>
        </article>
        <article className="glass rounded-2xl p-5">
          <p className="text-sm text-muted">Quiet Services</p>
          <p className="mt-2 text-lg font-semibold">{data?.error_free_service_count ?? 0}</p>
        </article>
      </section>
    </AnimatedContainer>
  );
